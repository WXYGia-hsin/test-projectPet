...
import com.wang.demo.model.Category;
import com.wang.demo.model.CategoryExample.Criteria;
import com.wang.demo.model.CategoryExample.Criterion;
import com.wang.demo.model.CategoryExample;
...
public class CategorySqlProvider {
    ...
    public String insertSelective(Category record) {
        ...
        if (record.getCatid() != null) {
            VALUES("catid", "#{catid,jdbcType=VARCHAR}");
        }
        ...
        if (record.getDescn() != null) {
            VALUES("descn", "#{descn,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getDescn() != null) {
            SET("descn = #{record.descn,jdbcType=VARCHAR}");
        }
