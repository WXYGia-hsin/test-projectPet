...
import com.wang.demo.model.Orders;
import com.wang.demo.model.OrdersExample.Criteria;
import com.wang.demo.model.OrdersExample.Criterion;
import com.wang.demo.model.OrdersExample;
...
public class OrdersSqlProvider {
    ...
    public String insertSelective(Orders record) {
        ...
        if (record.getTotalprice() != null) {
            VALUES("totalprice", "#{totalprice,jdbcType=DECIMAL}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getTotalprice() != null) {
            SET("totalprice = #{record.totalprice,jdbcType=DECIMAL}");
        }
